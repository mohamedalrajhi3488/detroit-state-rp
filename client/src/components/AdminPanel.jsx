...
import { savePagesToFirestore, saveShopProductsToFirestore, saveUsersToFirestore } from '../firebase'
...
export default function AdminPanel({ user, data, activityLog = [], onDataChange, onActivityAdd, onActivityDelete, onDeleteAllActivities, onLogout }) {
  ...
  const commitData = (
    ...
    if (Array.isArray(nextUsers)) {
      saveUsersToFirestore(nextUsers).catch(() => {})
    }
  ...
  const saveSettings = (event) => {
    ...
    const nextSettings = {
      ...
      title: formData.get('title') || 'Royal Community',
